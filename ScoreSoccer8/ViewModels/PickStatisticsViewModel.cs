...
{
    public class PickStatisticsViewModel : Notification
    {
        public int _gameId;
        ...
        private ICommand _goToTimelineCommand;
        public ICommand GoToTimelineCommand
        {
            get
            {
                if (_goToTimelineCommand == null)
                {
                    _goToTimelineCommand = new DelegateCommand(param => this.GoToTimeLine(), param => true);
                }

                return _goToTimelineCommand;
            }
        }
        private void GoToTimeLine()
        {
            (Application.Current.RootVisual as Frame).Navigate(new Uri("/Views/Statistics_Timeline.xaml?gameid=" + _gameId, UriKind.Relative));
        }


        private ICommand _goToGameStatsCommand;
        public ICommand GoToGameStatsCommand
        {
            get
            {
                if (_goToGameStatsCommand == null)
                {
                    _goToGameStatsCommand = new DelegateCommand(param => this.GoToGameStats(), param => true);
                }

                return _goToGameStatsCommand;
            }
        }
        private void GoToGameStats()
        {
            (Application.Current.RootVisual as Frame).Navigate(new Uri("/Views/Statistics_GameStats.xaml?gameid=" + _gameId, UriKind.Relative));
        }


        private ICommand _goToHomeTeamBoxscoreCommand;
        public ICommand GoToHomeTeamBoxscoreCommand
        {
            get
            {
                if (_goToHomeTeamBoxscoreCommand == null)
                {
                    _goToHomeTeamBoxscoreCommand = new DelegateCommand(param => this.GoToHomeTeamBoxscore(), param => true);
                }

                return _goToHomeTeamBoxscoreCommand;
            }
        }

        private void GoToHomeTeamBoxscore()
        {
            (Application.Current.RootVisual as Frame).Navigate(new Uri("/Views/Statistics_TeamBoxscore.xaml?gameid=" + _gameId + "&teamid=" + _game.HomeTeam.TeamID, UriKind.Relative));
        }


        private ICommand _goToAwayTeamBoxscoreCommand;
        public ICommand GoToAwayTeamBoxscoreCommand
        {
            get
            {
                if (_goToAwayTeamBoxscoreCommand == null)
                {
                    _goToAwayTeamBoxscoreCommand = new DelegateCommand(param => this.GoToAwayTeamBoxscore(), param => true);
                }

                return _goToAwayTeamBoxscoreCommand;
            }
        }
        private void GoToAwayTeamBoxscore()
        {
            (Application.Current.RootVisual as Frame).Navigate(new Uri("/Views/Statistics_TeamBoxscore.xaml?gameid=" + _gameId + "&teamid=" + _game.AwayTeam.TeamID, UriKind.Relative));
        }


        private ICommand _goToPlayByPlayCommand;
        public ICommand GoToPlayByPlayCommand
        {
            get
            {
                if (_goToPlayByPlayCommand == null)
                {
                    _goToPlayByPlayCommand = new DelegateCommand(param => this.GoToPlayByPlay(), param => true);
                }

                return _goToPlayByPlayCommand;
            }
        }
        private void GoToPlayByPlay()
        {
            (Application.Current.RootVisual as Frame).Navigate(new Uri("/Views/Statistics_PlayByPlay.xaml?gameid=" + _gameId + "&teamid=" + _game.AwayTeam.TeamID, UriKind.Relative));
        }
        ...
        {
            (Application.Current.RootVisual as Frame).Navigate(new Uri("/Views/Help_Buttons.xaml?screenId=" + Enums.Screen.Stats, UriKind.Relative));
        }
